...
<script>
  ...
  import debounce from 'lodash/debounce'
	...
	import Post from '$lib/components/instill-v1/blocks/Post.svelte';

	// import Dropdown from '$lib/components/sidekit/dropdown.svelte';
  import { getVotes } from '$plasmid/modules/instill-pocketbase/votes'
  import { getPosts, doPost } from '$plasmid/modules/instill-pocketbase/posts'
  import { getProfiles } from '$plasmid/modules/instill-pocketbase/profiles'
  ...
  <div class="Panel-Controller | mt-4">
    <div class="Card bg-gray-100">
      <div class="Card-body">
        ...
        <button class="btn-solid mt-2" on:click={()=>{showEditor=!showEditor}}>New post</button>
      </div>
