...
<script>
  ...
  import { getReplies, doReply } from '$plasmid/modules/instill-pocketbase/replies'

	import Reply from '$lib/components/instill-v1/blocks/Reply.svelte';
  import debounce from 'lodash/debounce'

  import { doUpvote, getVotes } from '$plasmid/modules/instill-pocketbase/votes'

  export let source, replies, profiles, root, showVotes=true
