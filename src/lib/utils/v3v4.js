...
export function updateCapsid(v3) {
	...
	// v4: { fields: }
  v3['fields'] = v3['manuscript']?.['fields'] || v3['fields']
  ...
  let articleKeys = {
    ...
    "Abstract": "Data:Lede",
    "Authors": "Data:MainAuthorSlug",
    "Authors::Secondary": "Data:AuthorSlugs",
    "Content": "Data:Body",
    "URL": "URL",
  ...
  Object.keys(articleKeys).map(key => {
	...
	// v4 is called 'posts' and not 'feed'; so we're reassigning it
	v3['posts'] = feed
	delete v3['feed']
